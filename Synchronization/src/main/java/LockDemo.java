...
public class LockDemo {
	 ...
	 *
	 * <p>
	 * Whether A1, A2, B1, B2 are able to run simultaneously (e.g. threads are able
	 * to enter the "locked rooms" setup by each thread) depends on the type of
	 * lock/key used. If there are not enough "keys" then threads will be blocked.
	 *
	 * @param args unused
	 * @throws InterruptedException if interrupted
	 */
