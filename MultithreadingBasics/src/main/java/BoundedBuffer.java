...
public class BoundedBuffer<E> {
	...
	/**
	 * Convenience method for adding multiple items at once. Not the most efficient
	 * implementation, but demonstrates that synchronized methods can call other
	 * synchronized methods since the thread already holds the appropriate lock.
	 *
	...
	/**
	 * Removes and returns an element from the buffer. If the buffer is empty, waits
	 * until there is an element to retrieve.
	 *
