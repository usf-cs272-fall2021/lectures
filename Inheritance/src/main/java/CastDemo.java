...
public class CastDemo {
	...
	public static void numberDemo() {
		// This is upcasting the identifier from a Double instance to its superclass
		// Number.
	...
	public static void arrayDemo() {
		...
		Number[] numbers = new Number[] {
				Double.valueOf(3.14), Integer.valueOf(42), BigInteger.valueOf(123456789)
		};
	...
	public static void objectDemo() {
		...
		Object[] objects = new Object[] {
				new CastDemo(), new String[] {"a"}, new StringBuilder("potato"),
	...
	public static void interfaceDemo() {
		...
		CharSequence[] chars = new CharSequence[] {
				new String("apple"), new StringBuffer("banana"), new StringBuilder("carrot")
		};
