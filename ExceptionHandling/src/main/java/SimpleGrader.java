...
public class SimpleGrader {
	 ...
	 *
	 * - NoSuchElementException if add before create Scanner:
	 * System.in.close();
	 *
	 * - IllegalStateException if add bug after scanner.close():
	 * System.out.println(scanner.nextLine());
	 *
	 * Generally, we do want reusable methods to throw exceptions. This allows other
	 ...
	 * debugging (not the user while using).
	 */
}
