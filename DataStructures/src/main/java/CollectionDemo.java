...
//		Collections.addAll(wordTreeSet, words);
	...
	public static void main(String[] args) {
		...
		// "a grammatically correct sentence that starts in such a way that a reader's
		// most likely interpretation will be incorrect"
		...
		// Rose [a person] rose [stood] to put rose [pink-colored] roes [fish eggs as
		// fertilizer] on her rows of roses [flower].
