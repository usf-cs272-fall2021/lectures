...
public class ContextServer {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * Examples:
		 *
		 * http://localhost:8080/resources http://localhost:8080/resources/src
		 * http://localhost:8080/resources/nowhere http://localhost:8080/resources/hello
		 *
		 * http://localhost:8080/servlets/hello http://localhost:8080/servlets/today
		 * http://localhost:8080/servlets/nowhere http://localhost:8080/servlets/
		 *
		 * http://localhost:8080/ http://localhost:8080/favicon.ico
		 * http://localhost:8080/nowhere http://localhost:8080/hello
		 */
	}
}
