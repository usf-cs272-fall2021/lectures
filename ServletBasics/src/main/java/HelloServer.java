...
public class HelloServer {
	 ...
	 * hello to the user. Demonstrates XSS attacks caused by this approach. THIS IS
	...
	public static class HelloServlet extends HttpServlet {
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			/*
			 * This can lead to a cross-site scripting attack! NEVER directly use input from
			 * the user in your webpage.
			 *
			 * Some browsers are smart enough to not load Javascript found within the URL
			 * request... so these examples may no longer work.
			 */
