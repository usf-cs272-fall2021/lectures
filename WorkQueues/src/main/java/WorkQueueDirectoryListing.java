...
public class WorkQueueDirectoryListing {
	...
	/*
	 * So, are we FINALLY at the point where we are writing multithreading code the
	 * way you should in your homework and projects? Almost! The next step is to
	 * eliminate the task manager class entirely by moving the code that deals with
	 * the pending variable to the work queue itself.
	 */
}
